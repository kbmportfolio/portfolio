  ...
  return (
    <Container fluid="md" className='containerimg d-flex p-2'>
      <Row className="justify-content-md-center">
        ...
        <img src={Kevan} alt="kevan" className="kpic animate__animated animate__fadeIn animate__delay-1s" style={{ width: '350px' }} />
...
<br></br><br></br>
        ...
        <a href="https://github.com/kbmportfolio"> <i class="bi-github hero-icon"></i></a> <a href="https://www.linkedin.com/in/kevanmeratinia"
